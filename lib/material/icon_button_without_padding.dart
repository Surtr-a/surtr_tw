...
const double _kMinButtonSize = 0;
...
/// widget whose child is an [IconButtonWithoutPadding]. The icon button's filled background
...
class IconButtonWithoutPadding extends StatelessWidget {
  ...
  /// or an [ImageIcon].
  const IconButtonWithoutPadding({
    Key key,
    this.iconSize = 24.0,
    this.visualDensity,
  ...
  /// [Icon.size] property allows the [IconButtonWithoutPadding] to size the splash area to
  /// fit the [Icon]. If you were to set the size of the [Icon] using
  /// [Icon.size] instead, then the [IconButtonWithoutPadding] would default to 24.0 and then
